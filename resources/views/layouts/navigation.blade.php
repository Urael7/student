        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route(auth()->check() && auth()->user()->role === 'student' ? 'student.dashboard' : 'dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @php
                        $dashboardRoute = auth()->check() && auth()->user()->role === 'student' ? 'student.dashboard' : 'dashboard';
                    @endphp
